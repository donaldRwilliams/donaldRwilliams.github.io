...
(a.k.a., networks), multilevel models with heterogeneous variance components, 
meta-analysis, Bayesian inference, measurement reliability, predictive modeling,
and regularization. Further, I am the author of 11 `R` packages (most implementing novel methodology). 

Currently I am focusing on Bayesian Gaussian graphical models and Bayesian
