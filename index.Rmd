...
University of California, Davis. I have authored 28 peer-reviewed articles,
16 of which are first-author, with topics including [Gaussian graphical models 
(a.k.a., networks)](https://psycnet.apa.org/record/2020-12344-001?doi=1), [multilevel models with heterogeneous variance components](https://psycnet.apa.org/record/2020-33519-001), 
...
and [regularization](https://psyarxiv.com/ad57p/)^[The pre-print for each paper can be found in the [Publications](https://donaldrwilliams.github.io/publications.html) section.]. Further, I am the author of 
11 `R` packages (see [Software](https://donaldrwilliams.github.io/software.html)). 
