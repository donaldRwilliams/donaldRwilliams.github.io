...
icon_link(
    icon = 'fas fa-file-code',
    text = "BibTex",
    url  = "https://scholar.googleusercontent.com/scholar.bib?q=info:6men8C5zKN4J:scholar.google.com/&output=citation&scisdr=CgXiaix6EJfVrFFeCQ8:AAGBfm0AAAAAYNdYEQ_fYQK3SVVqkcA61ivIzor4Uv-X&scisig=AAGBfm0AAAAAYNdYEViFalmHeSzyabWBQlWHJq8f2pby&scisf=4&ct=citation&cd=-1&hl=en"
)
```
...
icon_link(
    icon = 'fas fa-file-code',
    text = "BibTex",
    url  = "https://scholar.googleusercontent.com/scholar.bib?q=info:_HD0mf1Pz5YJ:scholar.google.com/&output=citation&scisdr=CgXiaix6EJfVrFFFMfc:AAGBfm0AAAAAYNdDKfewztK0sEA3j-8YZ2JsU0fzKpYo&scisig=AAGBfm0AAAAAYNdDKU1VnG71jsQBM9i_4HZrqIiPyGOZ&scisf=4&ct=citation&cd=-1&hl=en"
)
