...
icon_link(
    ...
    text = "BibTex",
    url  = "https://scholar.googleusercontent.com/scholar.bib?q=info:cfB4PFcHWHcJ:scholar.google.com/&output=citation&scisdr=CgXiaix6EJfVrFFHFSo:AAGBfm0AAAAAYNdBDSo9JXt62v_J_bBkRZJ7wA3zSfCK&scisig=AAGBfm0AAAAAYNdBDQdeOBMPxLjBMp_Zsv8Z6B3yD13w&scisf=4&ct=citation&cd=-1&hl=en"
)
```
...
icon_link(
    icon = 'fas fa-file-code',
    text = "BibTex",
    url  = "https://scholar.googleusercontent.com/scholar.bib?q=info:6men8C5zKN4J:scholar.google.com/&output=citation&scisdr=CgXiaix6EJfVrFFHiJE:AAGBfm0AAAAAYNdBkJGMzAwZCZ3W0KiEL4vXOpTI5_xW&scisig=AAGBfm0AAAAAYNdBkKumuI3vlf0RqpJCE7oNHDC0Lu3d&scisf=4&ct=citation&cd=-1&hl=en"
)
...
* Highlights  (all first author)
  ...
  + Behavior Research Methods: 1 (solo author)
  + Psychometrika: 1 (solo author)
  + Journal of Open-Source Software: 1 (solo author)
  + R Journal: 1 (solo author)
...
```
@article{,
  title={Many Mixture Components, Oh My: Extending the 
         Spike and Slab to Bayesian Hypothesis Testing 
         with Multinoulli Indicators},
  author={Williams, Donald R},
  year={2021},
  publisher={PsyArXiv},
  doi = {10.31234/osf.io/xcvby}
}
```
...
```
@article{williams2021confidence,
  title={The Confidence Interval that Wasn’t: Bootstrapped 
         “Confidence Intervals” in L1-Regularized 
...
```
@article{,
  title={On Accepting the Null Hypothesis of Conditional 
         Independence in Partial Correlation Networks: 
         A Bayesian Analysis},
  author={Williams, Donald R and Briganti, 
          Giovanni and Linkowski, Paul 
          and Mulder, Joris},
  year={2021},
  journal={PsyArXiv},
...
```
@article{,
  title={Who Is and Is Not" Average'"? Random Effects 
...
```
@article{,
  title={Painless Posterior Sampling: Bayesian 
         Bootstrapped Correlation Coefficients},
  author={Rodriguez, Josue E and Williams, Donald R},
  year={2021},
  journal={PsyArXiv},
  doi={10.31234/osf.io/v2chs}
}
```
...
```
@article{jongerling2021bayesian,
  title={Bayesian Uncertainty Estimation for Gaussian 
         Graphical Models and Centrality Indices},
  author={Jongerling, Joran and Epskamp, Sacha 
  and Williams, Donald R},
  year={2021},
  journal={PsyArXiv},
  doi={10.31234/osf.io/7kude}
}
```
